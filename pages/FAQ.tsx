...
const FAQ: React.FC = () => {
  const faqs = [
    ...
    {
      q: "How do I locate Bright Tutorials in Vadasery?",
      a: "We are located near Oppo Popular Tailors, Vadasery, making the institute easy to find."
    },
    {
    ...
    },
    {
      ...
      a: "Monday–Saturday: 9:30 AM – 5:00 PM. Sunday: Closed."
    },
    {
    ...
    <div className="bg-blue-50 min-h-screen py-16">
       <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="mt-12 text-center bg-white p-8 rounded-xl shadow-sm">
            ...
            <a href="tel:07947111810" className="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">
              Call 07947 111 810
            </a>
         </div>
       </div>
